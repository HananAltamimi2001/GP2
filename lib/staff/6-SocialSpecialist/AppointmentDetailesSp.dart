...
class AppointmentDetailesSp extends StatefulWidget {
  final AppointmentInfoSp args;

  const AppointmentDetailesSp({
    Key? key,
    required this.args,
  }) : super(key: key);

  @override
  State<AppointmentDetailesSp> createState() => _AppointmentDetailesSpState();
}

class _AppointmentDetailesSpState extends State<AppointmentDetailesSp> {
...
class AppointmentInfoSp {
  final String appointmentId;
  final Map<String, dynamic> appointment;
  AppointmentInfoSp({required this.appointmentId, required this.appointment});
}
