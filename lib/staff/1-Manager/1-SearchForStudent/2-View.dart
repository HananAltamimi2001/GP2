...
class StudentViewM extends StatefulWidget {
  final DocumentReference sturef;
  const StudentViewM({super.key, required this.sturef});

  @override
  State<StudentViewM> createState() => _StudentViewMState();
}

class _StudentViewMState extends State<StudentViewM> {
